...
<div class="container">
    <div class="row" id="qs">
        ...
        <div class="col-12" id="Nvision">
            <h2>Nuestra vision</h2>
            <p>Ser la plataforma líder en difusión educativa más grande del país, dando los materiales para que las mentes creativas puedan expresarse y conectar tanto con sus estudios como con sus talentos</p>
        ...
        <div class="card" id="card-qs"style="width: 16rem;">
            <img src="img/Da-vinci.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h4>Vicente de Leonardo | Director ejecutivo</h4>
            </div>
        </div>
        <div class="card" id="card-qs" style="width: 16rem;">
            <img src="img/The-weeknd-estudiando.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h4>Abel Tayase | Jefe de Operaciones</h4>
            </div>
        </div>
    </div>
</div>
